    ...
    try {
        ...
        switch (acao) {
            ...
            case 6:
                ...
                break;
            case 7:
                const mediaPesoProdutos = await (0, controleEstoque_1.listarProdutos)();
                ...
                break;
            case 8:
                const itemTotal = await (0, controleEstoque_1.listarProdutos)();
                ...
                break;
            case 9:
                const itemEspecificosTotal = await (0, controleEstoque_1.listarProdutos)();
